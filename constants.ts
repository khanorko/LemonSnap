...
export const STYLES: StyleDefinition[] = [
  ...
  { id: "professional", title: "Professional", category: "Professional & Personal Branding", desc: "High-end corporate headshot. Soft, even lighting with a clean, blurred office background. Professional attire, confident expression. Shot on 85mm lens for flattering compression.", funFactor: 3, moodPalette: ["#f9f9f9", "#e0e0e0", "#c4c4c4"] },
  { id: "studio", title: "Studio", category: "Professional & Personal Branding", desc: "Classic studio portrait on a seamless neutral grey background. Three-point lighting setup with a key light, fill light, and hair light. Sharp focus on eyes.", funFactor: 3, moodPalette: ["#ffffff", "#eeeeee", "#dcdcdc"] },
  { id: "editorial", title: "Editorial", category: "Professional & Personal Branding", desc: "Magazine-style portrait with dramatic, directional lighting. High contrast, rich shadows, and a confident, intense gaze. Fashion-forward styling and composition.", funFactor: 6, moodPalette: ["#faf7f5", "#cfc6be", "#7f7b76"] },
  { id: "tech_corp", title: "Tech", category: "Professional & Personal Branding", desc: "Modern tech industry aesthetic. Cool color temperature, sleek glass and steel background elements. Smart-casual attire. Futuristic and innovative vibe.", funFactor: 4, moodPalette: ["#e0f2f1", "#b2dfdb", "#009688"] },
  { id: "executive", title: "Executive Glow", category: "Professional & Personal Branding", desc: "Premium executive portrait. Warm, golden lighting reflecting success and approachability. Luxurious blurred background (mahogany, leather, or high-end office).", funFactor: 4, moodPalette: ["#fff9c4", "#fbc02d", "#f57f17"] },
