...
export const STYLES: StyleDefinition[] = [
  ...
  // 7. Animal Kingdom
  { id: "wild", title: "Wild Spirit", category: "Animal Kingdom", desc: "Wild spirit portrait. Avant-garde fashion interpretation of lion/wolf themes. Thematic texture and styling. Regal and untamed atmosphere.", funFactor: 9, moodPalette: ["#fff3e0", "#ffe0b2", "#ffcc80"] },
  { id: "pet", title: "Pet Power", category: "Animal Kingdom", desc: "Whimsical pet-inspired portrait. Cute and friendly styling with subtle thematic accessories. Playful and warm.", funFactor: 8, moodPalette: ["#efebe9", "#d7ccc8", "#a1887f"] },
  { id: "fantasy_animal", title: "Fantasy Creature", category: "Animal Kingdom", desc: "Fantasy inspired high-fashion portrait. Iridescent textures and magical aura. Mythical elegance with thematic styling elements.", funFactor: 10, moodPalette: ["#fce4ec", "#f8bbd0", "#f48fb1"] },
  { id: "arctic", title: "Arctic Fox", category: "Animal Kingdom", desc: "Arctic spirit portrait. Icy blue color palette, white winter styling. Cool and pristine fashion photography.", funFactor: 8, moodPalette: ["#e3f2fd", "#bbdefb", "#90caf9"] },
  { id: "jungle", title: "Jungle Panther", category: "Animal Kingdom", desc: "Artistic jungle panther inspired portrait. Shadowy, sleek, green jungle atmosphere. Predatory and stealthy mood. Avant-garde fashion interpretation with thematic makeup.", funFactor: 8, moodPalette: ["#e8f5e9", "#c8e6c9", "#a5d6a7"] },
  { id: "safari", title: "Safari Guide", category: "Animal Kingdom", desc: "Safari explorer fashion. Khaki tones, savannah atmosphere. Adventure ready look with subtle animal print styling.", funFactor: 7, moodPalette: ["#fff8e1", "#ffecb3", "#ffe082"] },
  { id: "mythic", title: "Mythic Lion King", category: "Animal Kingdom", desc: "Regal golden portrait. Powerful lighting, royal attire hints. Thematic gold makeup accents. Kingly presence.", funFactor: 9, moodPalette: ["#fffde7", "#fff9c4", "#fff59d"] },
  { id: "raven", title: "Raven Spirit", category: "Animal Kingdom", desc: "Gothic fashion portrait. Dark feathers integrated into styling. Mysterious and intense atmosphere. High contrast.", funFactor: 8, moodPalette: ["#212121", "#424242", "#616161"] },
  { id: "tiger", title: "Tiger Gaze", category: "Animal Kingdom", desc: "Fierce portrait with tiger-inspired lighting and makeup. Intense orange and black contrast. Bold and powerful gaze.", funFactor: 9, moodPalette: ["#ffe0b2", "#ffcc80", "#ffb74d"] },
  { id: "aquatic", title: "Aquatic Muse", category: "Animal Kingdom", desc: "High-fashion aquatic shoot. Wet look styling, ocean tones, soft underwater lighting. Ethereal beauty.", funFactor: 8, moodPalette: ["#e0f7fa", "#b2ebf2", "#80deea"] },
  { id: "wolf", title: "Moon Wolf", category: "Animal Kingdom", desc: "Mystical night portrait. Cool moonlight, spirit wolf thematic elements in background and styling. Intense and mysterious.", funFactor: 8, moodPalette: ["#eceff1", "#cfd8dc", "#b0bec5"] },
  { id: "cosmic_cat", title: "Cosmic Feline", category: "Animal Kingdom", desc: "Galactic fashion portrait. Starry textures, feline-inspired makeup accents. Glimmering mystery against deep space.", funFactor: 10, moodPalette: ["#f3e5f5", "#e1bee7", "#ce93d8"] },
